...
description: This section provides an overview of how NoahDocs handles links and images in Markdown.
---

In NoahDocs, all links and images written in Markdown are automatically converted to their respective Next.js components. This allows for better optimization and performance in your application.
